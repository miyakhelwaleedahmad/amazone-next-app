...
const SportsOutdoors = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // 🏏 Using "sports-accessories" category as Sports & Outdoors
        const res = await fetch("https://dummyjson.com/products/category/sports-accessories");
        const data = await res.json();
        setProducts(data.products);
      } catch (error) {
        console.error("Error fetching Sports & Outdoors products:", error);
      }
    };
    fetchProducts();
  }, []);
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold">Sports & Outdoors</h1>
