...
// Update the import path to the correct location of StoreProduct type
// Define StoreProduct type locally if not available from "@/store/types"
type StoreProduct = {
  id: number;
  title: string;
  brand: string;
...
const HomeKitchen = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // 🍳 Using "home-decoration" category as Home & Kitchen
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold">Home & Kitchen</h1>
